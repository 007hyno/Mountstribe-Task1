	            ...
	            <div className="row">
	              <div className="col-12">
	                ...
	                <p className="mb2 footerLinks">
	                  <span className="col_white_amrc pt2">All Subscriptions: </span> <Link to='/store/microgreens-blush' className='nav-link'>Microgreens Blush</Link> | <Link to='/store/organic-wheatgrass'>Organic Wheatgrass</Link>
	                </p>
	              </div>
	            </div>
	            <div className="row">
